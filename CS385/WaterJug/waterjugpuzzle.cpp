...
//Class to hold the path to get to the final state
class State
{
	private:
...
//returns the int stored in jug_a
int State::get_a()
{
	return jug_a;
}

//returns the int stored in jug_b
int State::get_b()
{
	return jug_b;
}

//returns the int stored in jug_c
int State::get_c()
{
	return jug_c;
}

//Prints out the contents of the edge vector
...
//builds the initial state string and puts it into the vector
...
//Builds the string printed in the output
...
//Breadth First Search to build the best path possible
