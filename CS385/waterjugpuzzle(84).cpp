	...
	while(!pours.empty())
	{
		...
		if(jug_a < cap_a)
		{
			if(jug_b != 0)
			{
				...
				{
					iss << (jug_b - b);
					std::string text = "Pour " + iss.str() + " gallon from B to A. ";
				}
		...
		if(jug_b < cap_b)
		{
			...
			{
				iss << (b - jug_b);
				std::string text = "Pour " + iss.str() + " gallon from C to B. ";
			}
		...
		if(jug_b < cap_b)
		{
			if(jug_a != 0)
			{
				...
				{
					iss << (b - jug_b);
					std::string text = "Pour " + iss.str() + " gallons from A to B. ";
				}
				else
				{
					iss << (b - jug_b);
					std::string text = "Pour " + iss.str() + " gallon from A to B. ";
				}
